...
public class TMXHandler extends DefaultHandler {
	...
	public void startElement(String namespaceURI, String localName, String qName, Attributes atts) throws SAXException {
		if(localName.equals("map")) { 
			...
			if(atts.getValue("width") != null && !atts.getValue("width").equals("null")){
				currentObject.width = Integer.parseInt(atts.getValue("width"));
			}
			if(atts.getValue("height") != null && !atts.getValue("height").equals("null")){
		...
		} else if(localName.equals("property") && currentObject != null){
			currentObject.properties.put(atts.getValue("name"), atts.getValue("value"));
		}
	}
